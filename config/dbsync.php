...
return [
     ...
     */
    'useSsh' => env('REMOTE_USE_SSH', TRUE),

    /*
     * Set the remote host either an IP address or URL
     */
    'host' => env('REMOTE_DATABASE_HOST', 'cries.ro'),
     ...
     * Database username
     */
    'username' => env('REMOTE_DATABASE_USERNAME', 'cries_test'),
     ...
     */
    'database' => env('REMOTE_DATABASE_NAME', 'cries_harta_la_pas'),

    /*
     * Set the database password
     */
    'password' => env('REMOTE_DATABASE_PASSWORD', '112DavidP'),
